...
Now we are going to proceed with the augmentation of the mouse and human datasets
...
## We are going now to perform an augmentation on the human dataframe
...
This is going to be the dataframe format used for the PCA analysis with the relative expression levels
...
```{r}
#Write the augmented datasets for the two human files

write_tsv(x = rel_mouse_df, file = str_c("../data/04_dat_aug_mouse", ".tsv.gz"))

write_tsv(human_log_expression, "../data/03_dat_aug_human.tsv.gz")
