...
freq_plot_mouse
ggsave("../results/mouse_freqpoly.png")
```
...
freq_log_plot_mouse
ggsave("../results/mouse_log_freqpoly.png")
...
ggplot(average_activity_treatment_replicate,
  ...
  labs(title = "Average Gene Activity by Treatment and Replicate",
       ...
       y = "Average Activity")
ggsave("../results/mouse_gene_activity_barplot.png")
...
We can see that most genes either have all zeroes (\~40%) or all non-zeroes( 33%).
...
ggsave("../results/human_freqpoly.png")
...
human_aug |>
  ...
  geom_freqpoly()+ 
  facet_wrap(~treatment)
ggsave("../results/human_log_freqpoly.png")
```
...
ggplot(mapping = aes(x = cell_line, 
  ...
  theme(axis.text.x = element_text(angle = 45), 
        axis.text = element_text(vjust = 0.5, 
                                 size = 6))
ggsave("../results/human_gene_activity_barplot.png")
```
...
ggsave("../results/human_signif_genes.png")
