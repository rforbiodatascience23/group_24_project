...
freq_plot_mouse
ggsave("../results/03_key_plot_1.png")
```
...
freq_log_plot_mouse
ggsave("../results/03_key_plot_2.png")
...
ggplot(average_activity_treatment_replicate,
  ...
  labs(title = "Average Gene Activity by Treatment and Replicate",
       ...
       y = "Average Activity")
ggsave("../results/03_mouse_gene_activity_barplot.png")
...
mouse_zero_plot
ggsave("../results/03_key_plot_4.png", bg = "white", device = "png")
```
...
ggsave("../results/03_key_plot_5.png")
...
zero_counts_genes |> 
  ...
  labs(title = "Inactive Gene Percentage per Sample", 
       x = "Number of Samples", 
       y = "Percentage of Genes")
ggsave("../06_results/03_key_plot_6.png", bg = "white", device="png")
```
...
ggplot(mapping = aes(x = cell_line, 
  ...
  theme(axis.text.x = element_text(angle = 45), 
        axis.text = element_text(vjust = 0.5, 
                                 size = 6))
ggsave("../results/03_key_plot_6.png")
```
...
ggsave("../results/03_key_plot_7.png")
