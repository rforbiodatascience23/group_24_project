...
freq_plot_mouse
ggsave("../results/04_key_plot_1.png", bg = "white", device = "png")
```
...
freq_log_plot_mouse
ggsave("../results/04_key_plot_2.png", bg = "white", device = "png")
...
mouse_zero_plot <- zero_counts_genes |> 
  ...
  coord_flip()
mouse_zero_plot
ggsave("../results/04_key_plot_4.png", bg = "white", device = "png")
```
...
ggsave("../results/04_key_plot_5.png", bg = "white", device = "png")
```
...
human_freq_plot2 <- human_aug |>
  ...
  geom_freqpoly()+ 
  facet_wrap(~treatment)
ggsave("../results/04_key_plot_6.png", bg = "white", device = "png")
```
...
zero_counts_genes |> 
  ...
  theme_minimal() + 
   labs(title = "Investigation of gene expression in each sample ", 
       ...
       y = "Percentage of Genes")+
  coord_flip()
ggsave("../results/04_key_plot_7.png", bg = "white", device="png")
```
...
ggplot(mapping = aes(x = cell_line, 
  ...
  theme(axis.text.x = element_text(angle = 45), 
        axis.text = element_text(vjust = 0.5, 
                                 size = 6))
ggsave("../results/04_key_plot_8.png", bg = "white", device="png")
```
...
ggsave("../results/04_key_plot_9.png", bg = "white", device="png")
