...
human_sup_data <- read_tsv(str_c(raw_dir, "human_supp.txt"))
...
#  variablename <- read_tsv(file = str_c(data_dir,"mouse.tsv"))
#  
#  
# }
...
mouse_sup_data <- read_tsv(str_c(raw_dir, "mouse_supp.txt"))
