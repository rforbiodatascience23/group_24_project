...
test <- select(human_clean, -c(treatment, replicate))
zeroes_removed_human <- test %>% select_if(~ !all(. == 0))
...
```
After cleaning we have a data set with the gene_ids as variables and cell line and treatment as rows.
