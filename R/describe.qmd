...
human_data_final$DMSO<- as.numeric(human_data_final$DMSO)
human_data_final$G007.LK<-as.numeric(human_data_final$G007.LK)
```
...
```{r}
human_log_trans<- human_data_final|> 
  mutate(
