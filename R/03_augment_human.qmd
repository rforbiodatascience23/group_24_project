...
### This were we create the new metrics for our augmented file

In order to transform our DMSO and G007.LK values we chose to move with log transformation.
...
```{r}
human_diff_expr <- human_joined_aug |>
  filter(log2fold != 1)
